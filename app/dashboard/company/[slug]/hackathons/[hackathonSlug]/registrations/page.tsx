...
export default function HackathonRegistrationsPage() {
    ...
    const fetchRegistrations = useCallback(async () => {
        if (!currentCompany || !hackathonSlug) return
        ...
        try {
            ...
            const response = await fetch(`/api/hackathons/${hackathonSlug}/registrations?${params.toString()}`)
    ...
    }, [currentCompany, hackathonSlug, searchTerm, statusFilter, paymentFilter])
    ...
    const handleExportCSV = async () => {
        try {
            setExporting(true)
            const response = await fetch(`/api/hackathons/${hackathonSlug}/registrations/export`)
            ...
            a.href = url
            a.download = `${hackathonSlug}-registrations-${new Date().toISOString().split('T')[0]}.csv`
    ...
    const handleUpdateStatus = async (registrationId: number, status: string) => {
        try {
            const response = await fetch(`/api/hackathons/${hackathonSlug}/registrations`, {
                method: 'PATCH',
        ...
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                    <Link href={`/dashboard/company/${currentCompany.slug}/hackathons`}>
                    ...
                    <div>
                        <h1 className="text-3xl font-bold tracking-tight">Hackathon Registrations</h1>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Manage and view all hackathon registrations
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    {loading ? (
                        ...
                        <div className="text-center py-12">
                            ...
                            <p className="text-gray-500 dark:text-gray-400">
                                {searchTerm || statusFilter !== 'all' || paymentFilter !== 'all'
                                    ...
                                    : 'No one has registered for this hackathon yet'}
                            </p>
                        </div>
                    ) : (
