...
import { JudgesForm } from "@/components/forms/judges-form";
import { cn } from "@/lib/utils";
import { motion } from "framer-motion";
import { Sparkles, Users, Star, Trophy, Gavel } from "lucide-react";
    ...
    const benefits = [
        {
            ...
            description: "Gain recognition as an expert judge in the developer community and build your professional reputation.",
            color: "text-blue-500",
        },
        {
            icon: Star,
            title: "Network Expansion",
            description: "Connect with other industry experts, developers, and potential collaborators from around the world.",
            color: "text-green-500",
        },
        {
            icon: Users,
            title: "Mentorship Opportunities",
            description: "Guide and inspire the next generation of developers through your expertise and feedback.",
            color: "text-purple-500",
        },
        {
            icon: Gavel,
            title: "Industry Impact",
            description: "Help shape the future of developer education and innovation through your judging decisions.",
            ...
            <section className="py-20 md:py-32 relative overflow-hidden">
                ...
                >
                    <div className="max-w-4xl mx-auto text-center space-y-8">
                        ...
                        >
                            Share your expertise and help evaluate innovative projects. Your insights will guide the next generation of developers.
                        </motion.p>
                    </div>
                </motion.div>
            </section>
                ...
                <div className="container px-4 mx-auto">
                    ...
                    >
                        ...
                        <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                            Discover the benefits of joining our prestigious judging panel and making a lasting impact.
                        </p>
                    </motion.div>
                ...
                <div className="container px-4 mx-auto">
                    <div className="max-w-4xl mx-auto">
                        ...
                        >
                            ...
                            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                                Fill out the form below to join our judging panel. We&apos;ll review your application and get back to you within 48 hours.
                            </p>
                        </motion.div>
