...
// GET: Fetch all registrations for a hackathon
export async function GET(
    ...
    try {
        ...
        // Debug logging
        console.log('=== HACKATHON REGISTRATIONS DEBUG ===');
        console.log('Hackathon ID:', hackathon.id);
        console.log('Hackathon ID type:', typeof hackathon.id);
        console.log('Activity ID being queried:', hackathon.id.toString());
        ...
        console.error('Error in hackathon registrations API:', error);
        return NextResponse.json(
