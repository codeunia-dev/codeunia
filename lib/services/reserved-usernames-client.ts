...
export class ReservedUsernameClientService {
  private static instance: ReservedUsernameClientService;
  private cache: Map<string, ReservedUsername[]> = new Map();
  private cacheExpiry: number = 5 * 60 * 1000; // 5 minutes
  private lastCacheUpdate: number = 0;

  public static getInstance(): ReservedUsernameClientService {
    if (!ReservedUsernameClientService.instance) {
      ReservedUsernameClientService.instance = new ReservedUsernameClientService();
    }
    return ReservedUsernameClientService.instance;
  }
  ...
  public getFallbackReservedUsernames(): string[] {
    return [
      ...
      // Brand & Identity
      'codeunia', 'build', 'buildunia', 'code', 'coders', 'student',
...
export const reservedUsernameClientService = ReservedUsernameClientService.getInstance(); 