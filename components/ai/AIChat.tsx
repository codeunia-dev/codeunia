...
export default function AIChat() {
  ...
  const sendMessage = async (messageText?: string) => {
    ...
    const thinkingId = `widget-thinking-${Date.now()}`;
    ...
    const streamingId = `widget-streaming-${Date.now()}`;
                ...
                <div className="space-y-4">
                  {messages.map((message) => (
                    ...
                    >
                      ...
                      <div
                        className={`max-w-[80%] rounded-2xl p-3 group relative ${message.sender === 'user'
                              ...
                              <div className="flex items-center gap-1">
                                ...
                                <div className="opacity-0 group-hover:opacity-100 transition-opacity flex gap-1">
                                  <Button
                                    variant="ghost"
                                    size="sm"
                                    className={`h-6 w-6 p-0 transition-colors ${message.sender === 'user'
